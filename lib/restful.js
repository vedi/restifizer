...
function Restful(options) {
  ...
  this.modelFieldNames = this.options.fields || this.getModelFieldNames(this.ModelClass);
...
_.extend(Restful.prototype, {
  ...
  select: function (req, res, next) {
    ...
    Seq()
      .seq(function () {
        try {
          _this.options.select.pre(req, res, this);
        } catch (e) {
          this(e);
        }
      })
      .seq(function () {
        ...
        try {
          ...
          if (q) {
            var qExpr = [];
            _.forEach(_this.options.qFields, function (qField) {
              var obj = {};
        ...
        // limit
        limit = _this.getLimit(req, _this.options.config.defaultPerPage, _this.options.config.maxPerPage);
        query.limit(limit);
        // page
      ...
      .seq(function (collection) {
        try {
          _this.options.select.post(collection, req, res, this);
        } catch (e) {
          this(e);
        }
      })
      ...
      .catch(function (err) {
        setResError(err, res, _this.options.log);
        next();
      }
    );
  },
  selectOne: function (req, res, next) {
    ...
    Seq()
      .seq(function () {
        try {
          _this.options.selectOne.pre(req, res, this);
        } catch (e) {
          this(e);
        }
      })
      .seq(function () {
        var fieldList = _this.getFieldList(req, _this.modelFieldNames);
        _this.ModelClass.findOne(_.pick(req.params, _.keys(req.params)), fieldList, this);
      })
      .seq(function (model) {
        try {
          _this.options.selectOne.post(model, req, res, this);
        } catch (e) {
          this(e);
        }
      })
  ...
  insert: function (req, res, next) {
    ...
    Seq()
      .seq(function () {
        try {
          _this.options.insert.pre(req, res, this);
        } catch (e) {
          this(e);
        }
      })
      .seq(function () {
        ...
        _this.assignAllFields(req, data, _.assign(req.body, params), _this.options.assignFilter, _.union(paramKeys, _this.modelFieldNames));
      ...
      .seq(function (model) {
        try {
          _this.options.insert.post(model, req, res, this);
        } catch (e) {
          this(e);
        }
      })
      .seq(function (model) {
        if (_this.options.redisClient) {
          // publish event
          _this.options.redisClient.publish(_this.options.config.redisKeyPrefix + ".resourceChanged." + _this.options.path + ".inserted", JSON.stringify(model));
        }
        this(null, model);
      })
      .seq(function (model) {
  ...
  update: function (req, res, next) {
    ...
    Seq()
      .seq(function () {
        try {
          _this.options.update.pre(req, res, this);
        } catch (e) {
          this(e);
        }
      })
      .seq(function () {
        _this.ModelClass.findOne(_.pick(req.params, _.keys(req.params)), this);
      })
      .seq(function (model) {
        if (!model) {
          this(createHttpStatusError(HTTP_STATUSES.NOT_FOUND));
        } else {
          _this.assignAllFields(req, model, req.body, _this.options.assignFilter, _this.modelFieldNames);
          this(null, model);
        }
      })
      .seq(function (model) {
      ...
      .seq(function (model) {
        try {
          _this.options.update.post(model, req, res, this);
        } catch (e) {
          this(e);
        }
      })
      .seq(function (model) {
        ...
        if (_this.options.redisClient) {
          // publish event
          _this.options.redisClient.publish(_this.options.config.redisKeyPrefix + ".resourceChanged." + _this.options.path + ".updated", JSON.stringify(model));
        }
        this(null, model);
      })
      .seq(function (model) {
  ...
  partialUpdate: function (req, res, next) {
    Seq()
      .seq(function () {
        try {
          _this.options.partialUpdate.pre(req, res, this);
        } catch (e) {
          this(e);
        }
      })
      ...
      .seq(function (model) {
        if (!model) {
          ...
          _this.assignExistingFields(req, model, req.body, _this.options.assignFilter, _this.modelFieldNames);
          this(null, model);
        }
      })
      .seq(function (model) {
      ...
      .seq(function (model) {
        try {
          _this.options.partialUpdate.post(model, req, res, this);
        } catch (e) {
          this(e);
        }
      })
      .seq(function (model) {
        ...
        if (_this.options.redisClient) {
          // publish event
          _this.options.redisClient.publish(_this.options.config.redisKeyPrefix + ".updated." + _this.options.path + ".inserted", JSON.stringify(model));
        }
        this(null, model);
      })
      .seq(function (model) {
  ...
  delete: function (req, res, next) {
    Seq()
      .seq(function () {
        try {
          _this.options.delete.pre(req, res, this);
        } catch (e) {
          this(e);
        }
      })
      ...
      .seq(function (model) {
        try {
          _this.options.delete.post(model, req, res, this);
        } catch (e) {
          this(e);
        }
      })
      .seq(function (model) {
        ...
        if (_this.options.redisClient) {
          // publish event
          _this.options.redisClient.publish(_this.options.config.redisKeyPrefix + ".resourceChanged." + _this.options.path + ".deleted", JSON.stringify(model));
        }
        this(null, model);
      })
      .seq(function () {
  ...
  count: function (req, res, next) {
    Seq()
      .seq(function () {
        try {
          _this.options.count.pre(req, res, this);
        } catch (e) {
          this(e);
        }
      })
      ...
      .seq(function (count) {
        try {
          _this.options.count.post({count: count}, req, res, this);
        } catch (e) {
          this(e);
        }
      })
  ...
  aggregate: function (req, res, next) {
    ...
    Seq()
      .seq(function () {
        try {
          _this.options.aggregate.pre(req, res, this);
        } catch (e) {
          this(e);
        }
      })
      ...
      .seq(function (collection) {
        try {
          _this.options.aggregate.post(collection, req, res, this);
        } catch (e) {
          this(e);
        }
      })
...
_.extend(RestfulFileField.prototype, {
  ...
  selectOne: function (req, res, next) {
    ...
    Seq()
      ...
      .seq(function () {
        var fileField;
        if (_this.options.fileField.type === "function") {
          fileField = _this.options.fileField();
        } else {
          fileField = _this.options.fileField;
        }
        _this.ModelClass.findOne(_.pick(req.params, _.keys(req.params)), fileField, this);
      })
      .seq(function (model) {
        if (!model) {
          this(createHttpStatusError(HTTP_STATUSES.NOT_FOUND));
      ...
      .seq(function (model) {
        _this.getFileField(options.fileField, model, this);
      })
      .seq(function (file, contentType) {
        var that = this;
        try {
          _this.options.selectOne.post(file, req, res, function() {
  ...
  update: function (req, res, next) {
    ...
    Seq()
      ...
      .seq(function () {
        _this.ModelClass.findOne(_.pick(req.params, _.keys(req.params)), _this.options.fileField, this);
      })
      .seq(function (model) {
        if (!model) {
          this(createHttpStatusError(HTTP_STATUSES.NOT_FOUND));
        } else {
          _this.setFileField(options.fileField, model, req, options.converter, this);
        }
      })
      .seq(function(model) {
        model.save(this);
  ...
  delete: function (req, res, next) {
    Seq()
      ...
      .seq(function () {
        //noinspection JSUnresolvedFunction
        _this.ModelClass.findOne(_.pick(req.params, _.keys(req.params)), options.fileField, this);
      })
      .seq(function (model) {
        if (!model) {
          this(createHttpStatusError(HTTP_STATUSES.NOT_FOUND));
        } else {
          _this.cleanFileField(options.fileField, model, this);
        }
      })
      .seq(function(model) {
        model.save(this);
...
function Controller(options) {
  ...
  this.select = _.defaults(this.select || {}, this.defaultMethodOptions);
  this.selectOne = _.defaults(this.selectOne || {}, this.defaultMethodOptions);
  this.insert = _.defaults(this.insert || {}, this.defaultMethodOptions);
  this.update = _.defaults(this.update || {}, this.defaultMethodOptions);
  this.partialUpdate = _.defaults(this.partialUpdate || {}, this.defaultMethodOptions);
  this.delete = _.defaults(this.delete || {}, this.defaultMethodOptions);
  this.count = _.defaults(this.count || {}, this.defaultMethodOptions);
  this.aggregate = _.defaults(this.aggregate || {}, this.defaultMethodOptions);

  this.initialize.apply(this, arguments);

  this.service = new Restful(this);
};
...
_.extend(Controller.prototype, {
  ...
  bind: function (app) {
    var _this = this;
    app.get(this.path,
      passport.authenticate(this.select.auth, { session: false }),
      function (req, res, next) {
        _this.service.select.apply(_this.service, arguments);
      },
      this.resultSender
    );
    app.get(this.path + '/count',
      passport.authenticate(this.count.auth, { session: false }),
      function (req, res, next) {
        _this.service.count.apply(_this.service, arguments);
      },
      this.resultSender
    );
    app.get(this.path + '/aggregate',
      passport.authenticate(this.aggregate.auth, { session: false }),
      function (req, res, next) {
        _this.service.aggregate.apply(_this.service, arguments);
      },
      this.resultSender
    );
    app.get(this.path + '/:_id',
      passport.authenticate(this.selectOne.auth, { session: false }),
      function (req, res, next) {
    ...
    app.post(this.path,
      passport.authenticate(this.insert.auth, { session: false }),
      function (req, res, next) {
        _this.service.insert.apply(_this.service, arguments);
      },
      this.resultSender
    );
    app.put(this.path + '/:_id',
      passport.authenticate(this.update.auth, { session: false }),
      function (req, res, next) {
        _this.service.update.apply(_this.service, arguments);
      },
      this.resultSender
    );
    app.patch(this.path + '/:_id',
      passport.authenticate(this.partialUpdate.auth, { session: false }),
      function (req, res, next) {
        _this.service.partialUpdate.apply(_this.service, arguments);
      },
      this.resultSender
    );
    app.delete(this.path + '/:_id',
      passport.authenticate(this.delete.auth, { session: false }),
      function (req, res, next) {
...
function FileFieldController(options) {
  ...
  this.service = new RestfulFileField(this);
};
...
_.extend(FileFieldController.prototype, {
  ...
  bind: function (app) {
    var _this = this;
    app.get(this.path,
      passport.authenticate(_this.selectOne.auth, { session: false }),
      function (req, res, next) {
        _this.service.selectOne.apply(_this.service, arguments);
      },
      _this.resultSender
    ...
    app.put(this.path,
      passport.authenticate(_this.update.auth, { session: false }),
      function (req, res, next) {
        _this.service.update.apply(_this.service, arguments);
      },
      _this.resultSender
    );
    app.delete(this.path,
      passport.authenticate(_this.delete.auth, { session: false }),
      function (req, res, next) {
        _this.service.delete.apply(_this.service, arguments);
      },
      _this.resultSender
