...
_.extend(Restful.prototype, {
  ...
  select: function (req, res, next) {
    ...
    Seq()
      .seq(function () {
        try {
          _this.selectOptions.pre(req, res, this);
        } catch (e) {
          this(e);
        }
      })
      ...
      .seq(function (collection) {
        try {
          _this.selectOptions.post(collection, req, res, this);
        } catch (e) {
          this(e);
        }
      })
  ...
  selectOne: function (req, res, next) {
    ...
    Seq()
      ...
      .seq(function (model) {
        try {
          _this.selectOneOptions.post(model, req, res, this);
        } catch (e) {
          this(e);
        }
      })
  ...
  insert: function (req, res, next) {
    ...
    Seq()
      .seq(function () {
        try {
          _this.insertOptions.pre(req, res, this);
        } catch (e) {
          this(e);
        }
      })
      ...
      .seq(function (model) {
        try {
          _this.insertOptions.post(model, req, res, this);
        } catch (e) {
          this(e);
        }
      })
  ...
  partialUpdate: function (req, res, next) {
    Seq()
      .seq(function () {
        try {
          _this.partialUpdateOptions.pre(req, res, this);
        } catch (e) {
          this(e);
        }
      })
      ...
      .seq(function (model) {
        try {
          _this.partialUpdateOptions.post(model, req, res, this);
        } catch (e) {
          this(e);
        }
      })
...
function Controller(options) {
  ...
  this.partialUpdateOptions = _.defaults(this.partialUpdateOptions  || {}, this.defaultMethodOptions);
  this.deleteOptions        = _.defaults(this.deleteOptions         || {}, this.defaultMethodOptions);
  this.countOptions         = _.defaults(this.countOptions          || {}, this.defaultMethodOptions);
  this.aggregateOptions     = _.defaults(this.aggregateOptions      || {}, this.defaultMethodOptions);
