...
_.extend(RestfulFileField.prototype, {
  ...
  selectOne: function (req, res, next) {
    ...
    Seq()
      ...
      .seq(function (model) {
        _this.getFileField(_this.options.fileField, model, this);
      })
    ...
    Seq()
      ...
      .seq(function (model) {
        if (!model) {
          ...
          _this.setFileField(_this.options.fileField, model, req, _this.options.converter, this);
        }
      })
      .seq(function(model) {
        model.save(this);
    ...
    Seq()
      ...
      .seq(function (model) {
        if (!model) {
          ...
          _this.cleanFileField(_this.options.fileField, model, this);
        }
      })
      .seq(function(model) {
        model.save(this);
