  ...
  bind: function (app) {
    ...
    _.forEach(this.path, _.bind(function (path) {
      if (this.selectOptions.enabled) {
        app.get(path,
          this.selectOptions.auth ? passport.authenticate(this.selectOptions.auth, { session: false }) : _this._emptyPre,
      ...
      if (this.countOptions.enabled) {
        app.get(path + '/count',
          this.countOptions.auth ? passport.authenticate(this.countOptions.auth, { session: false }) : _this._emptyPre,
          function (req, res, next) {
      ...
      if (this.aggregateOptions.enabled) {
        app.get(path + '/aggregate',
          this.aggregateOptions.auth ? passport.authenticate(this.aggregateOptions.auth, { session: false }) : _this._emptyPre,
          function (req, res, next) {
      ...
      if (this.selectOneOptions.enabled) {
        app.get(path + '/:_id',
          this.selectOneOptions.auth ? passport.authenticate(this.selectOneOptions.auth, { session: false }) : _this._emptyPre,
          function (req, res, next) {
      ...
      if (this.insertOptions.enabled) {
        app.post(path,
          this.insertOptions.auth ? passport.authenticate(this.insertOptions.auth, { session: false }) : _this._emptyPre,
          function (req, res, next) {
      ...
      if (this.updateOptions.enabled) {
        app.put(path + '/:_id',
          this.updateOptions.auth ? passport.authenticate(this.updateOptions.auth, { session: false }) : _this._emptyPre,
          function (req, res, next) {
      ...
      if (this.partialUpdateOptions.enabled) {
        app.patch(path + '/:_id',
          this.partialUpdateOptions.auth ? passport.authenticate(this.partialUpdateOptions.auth, { session: false }) : _this._emptyPre,
          function (req, res, next) {
      ...
      if (this.deleteOptions.enabled) {
        app.delete(path + '/:_id',
          this.deleteOptions.auth ? passport.authenticate(this.deleteOptions.auth, { session: false }) : _this._emptyPre,
          function (req, res, next) {
