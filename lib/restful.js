...
_.extend(Restful.prototype, {
  ...
  insert: function (req, res, next) {
    ...
    Q
      ...
      .then(function (doc) {
        return Q.ninvoke(_this, 'beforeSave', doc, req, res);
      })
      .then(function (doc) {
      ...
      .then(function (doc) {
        if (_this.afterChange) {
          return Q.ninvoke(_this, 'afterChange', doc, req, res);
        } else {
          return doc;
        }
      })
  ...
  partialUpdate: function (req, res, next) {
    ...
    Q
      ...
      .then(function (doc) {
        return Q.ninvoke(_this, 'proceedArrayMethods', doc, req.body, req);
      })
      .then(function (doc) {
        return Q.ninvoke(_this, 'beforeSave', doc, req, res);
      })
    ...
    Q
      ...
      .then(function (doc) {
        ...
        if (_this.deleteOptions.post) {
          return Q.nfcall(_.bind(_this.deleteOptions.post, _this), doc, req, res);
        } else {
          return doc;
        }
      })
  ...
  getFilter: function (req, callback) {
    ...
    Q
      ...
      .then(function (conditions) {
        var defaultFilter = _this.defaultFilter ? _this.defaultFilter : {};
  ...
  proceedArrayMethods: function proceedArrayMethods(dest, source, req, callback) {
    ...
    Q
      .try(function () {
        ...
        _.each(_this.arrayMethods, function (methodName) {
          var methodBody = source[methodName];
          if (methodBody) {
            // each affected field
            _.each(_.keys(methodBody), function (fieldName) {
              if (_this.assignFilter(dest, methodBody, fieldName, req)) {
                if (_this.beforeArrayMethod) {
                  _this.beforeArrayMethod(dest, methodBody[fieldName], methodName, fieldName, req);
                }
                _this.proceedArrayMethod(dest, methodBody[fieldName], methodName, fieldName, req);
              }
            });
          }
        });
