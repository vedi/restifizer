...
var setResData = function setResData(req, res, data) {
  if (req.method.toLowerCase() !== 'head') {
    res.restfulResult = data;
  }
};

var setResError = function setResError(req, res, err, log, controllerParseError, dsParseError) {
  var errorStatus,
    errorMessage,
    errorDetails;
  ...
  setResData(req, res, {error: errorStatus.message, message: errorMessage, details: errorDetails});
  if (log) {
...
var setResOk = function setResOk(res, code) {
